...
class Grupos extends My_Controller {
    ...
    public function getObjects_json(){
        ...
        $carregarResumo = $this->grupos_model->getObjects($_GET, false, false, true);
    ...
    public function getObject_json( $id ){
        ...
        $carregarObjecto = $this->grupos_model->getObject($id);
    ...
    public function postObject( $data ){
        ...
        $createObject = $this->grupos_model->postObject( $data );

        if( $createObject['sucesso'] )
            redirect(base_url().'grupos/?id='.$createObject['id']);
    ...
    public function getObjects_html()
    {
        ...
        $conteudo = $this->load->view('grupos/index', false, true);
    ...
    public function createTemplate(){
        ...
        $this->load->view('grupos/createTemplate', false);
