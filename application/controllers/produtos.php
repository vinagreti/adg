...
class Produtos extends My_Controller {
    ...
    public function getObjects_json(){
        ...
        $carregarResumo = $this->produtos_model->getObjects($_GET, false, false, true);
    ...
    public function getObject_json( $id ){
        ...
        $carregarObjecto = $this->produtos_model->getObject($id);
    ...
    public function postObject( $data ){
        ...
        $createObject = $this->produtos_model->postObject( $data );

        if( $createObject['sucesso'] )
            redirect(base_url().'produtos/?id='.$createObject['id']);
    ...
    public function getObjects_html()
    {
        ...
        $conteudo = $this->load->view('produtos/index', false, true);
    ...
    public function createTemplate(){
        ...
        $this->load->view('produtos/createTemplate', false);
