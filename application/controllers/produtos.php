...
class Produtos extends My_Controller {
    ...
    public function listObjects_json(){
        ...
        $carregarResumo = $this->produtos_model->resumo($_GET, false, false, true);
    ...
    public function createObject( $data ){
        ...
        $createObject = $this->produtos_model->create( $data );
    ...
    public function readObject_json( $id ){
        ...
        $carregarObjecto = $this->produtos_model->readObject($id);
